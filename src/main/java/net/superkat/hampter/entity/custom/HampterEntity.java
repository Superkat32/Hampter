...
public class HampterEntity extends PathAwareEntity implements IAnimatable {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(20, new PounceAtTargetGoal(this, 0.75f));
    ...
    public void tickMovement() {
        super.tickMovement();
        int airplaneChance = this.random.nextBetween(1, 2500);
    ...
    protected SoundEvent getAmbientSound() {
        return HampterMain.AMBIENT_SOUND_EVENT;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource source) {
        return HampterMain.HURT_SOUND_EVENT;
    }

    @Override
    protected SoundEvent getDeathSound() {
        return HampterMain.DEATH_SOUND_EVENT;
    }
